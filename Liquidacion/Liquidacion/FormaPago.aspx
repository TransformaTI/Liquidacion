...
=======
<%@ Register TagPrefix="DFP" TagName="DetalleFormaPago" Src="UserControl\DetalleFormaPago\wucDetalleFormaPago.ascx" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainPlaceHolder" runat="server">
    ...
    <script type="text/javascript">
       <!--
        function toggle(display, activo, inactivo, inactivoA,inactivoB, inactivoC, control) {
        ...
        document.getElementById(inactivo).style.display = 'none';
        document.getElementById(inactivoA).style.display = 'none';
        document.getElementById(inactivoB).style.display = 'none';
        document.getElementById(inactivoC).style.display = 'none';
        document.getElementById(control).focus();
    }

    //-->
>>>>>>> origin/feature_HMP_FormaPago_Trans_Anti
    </script>
    <script type="text/javascript">
       <!--
...
=======
                                                <asp:Image ID="imgTransferencia" runat="server"
                                                    ImageUrl="~/Imagenes/btnAceptarVerde85px.JPG" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                ...
                                <table style="vertical-align: top;">
                                    <tr>
                                        ...
                                        <tr>
                                            <td valign="top">
                                                <div id="Transferencia" style="display: none; vertical-align: top;">
                                                    <DFP:DetalleFormaPago ID="ucTransferencia" runat="server" ImgBoton="~/Imagenes/Aceptar.JPG"
                                                        ImgCal="~/images/Calendar_scheduleHS.png" Titulo="Transferencia Electrónica de Fondos" Tipo="1" />
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td valign="top">
                                                <div id="Anticipo" style="display: none; vertical-align: top;">
                                                    <DFP:DetalleFormaPago ID="ucAnticipo" runat="server" ImgBoton="~/Imagenes/Aceptar.JPG"
                                                        ImgCal="~/images/Calendar_scheduleHS.png" Titulo="Aplicación de anticipo" Tipo="2" />
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
