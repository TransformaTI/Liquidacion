...
// Type: SigametLiquidacion.WebControls.LiquidacionImageButton
...
{
  public class LiquidacionImageButton : ImageButton
  {
        ...
        protected override object SaveViewState()
    {
      ...
      objArray[6] = (object) this._formaLiquidacion;
    ...
    protected override void LoadViewState(object savedState)
    {
      ...
      this._formaLiquidacion = (string) objArray[6];
      this.EnsureChildControls();
    }
  }
}
